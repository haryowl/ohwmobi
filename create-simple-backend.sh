...
# Create simplified backend for Termux
cd ~/gali-parse

cat > termux-simple-backend.js << 'EOF'
...
echo "Simplified backend created successfully!"
echo "Now run: node termux-simple-backend.js" 